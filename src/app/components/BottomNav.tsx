      ...
      <div className="flex items-center justify-around max-w-md mx-auto relative">
        <Link
          ...
          className={`flex flex-col items-center gap-1 transition-all active:scale-95 ${
            active === "browse" ? "text-[#6B7A5C]" : "text-[var(--rw-ink)]/40"
          }`}
        >
        ...
        <Link
          to="/inbox"
          className={`flex flex-col items-center gap-1 transition-all active:scale-95 ${
            active === "inbox" ? "text-[#6B7A5C]" : "text-[var(--rw-ink)]/40"
          }`}
        >
        ...
        <Link
          to="/saved"
          className={`flex flex-col items-center gap-1 transition-all active:scale-95 ${
            active === "saved" ? "text-[#6B7A5C]" : "text-[var(--rw-ink)]/40"
          }`}
        >
        ...
        <Link
          to="/profile"
          className={`flex flex-col items-center gap-1 transition-all active:scale-95 ${
            active === "profile" ? "text-[#6B7A5C]" : "text-[var(--rw-ink)]/40"
          }`}
        >
