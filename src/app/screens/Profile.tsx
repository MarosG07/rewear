        ...
        <div className="px-4 pt-5 pb-6">
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h1 className="font-heading text-2xl text-[#3D3530] mb-1">Brandon Parker</h1>
                ...
                <Link to={`/item/${item.id}`}>
                  <div className="bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                    <div className="aspect-[3/4] relative overflow-hidden">
                      <SmartImage src={item.image} alt={item.name} className="w-full h-full object-cover" />
                      {item.status === "swapped" && (
