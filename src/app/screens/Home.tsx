        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-1.5">
              <MapPin
                className="w-3.5 h-3.5 text-[#6B7A5C]"
                strokeWidth={1.5}
              />
              <span className="text-[#3D3530] text-xs">
                Valencia, Spain
              </span>
            </div>
          </div>
        ...
        {viewMode === "grid" ? (
          items.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center px-8">
              ...
              <p className="text-[#3D3530]/60 text-sm mt-1">
                Be the first to list something in your neighborhood.
              </p>
            </div>
          ) : (
          ...
          <div className="h-full bg-[#E8DDD0] rounded-3xl mt-5 flex items-center justify-center">
            <div className="text-center">
              <Map
                className="w-12 h-12 text-[#6B7A5C] mx-auto mb-3"
                strokeWidth={1.5}
              />
              <p className="text-[#3D3530]/60">
